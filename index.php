...
<head>
    ...
    <title>Spectrum - Responsive Landing Page Template</title>
        ...
        <div class="container">
            ...
            <div id="navbar-collapse-02" class="collapse navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="#team">Nos Clients</a></li>
        ...
        <div class="container">
            ...
            <div class="row margin-bottom-30">
                ...
                <div class="col-md-12 text-center">
                    <h2 class="section-title">Why to Choose Spectrum?</h2>
            ...
            <div class="row">
                ...
                <div class="col-md-4 service-item">
                    ...
                    <div class="popup-wrapper">
                        <div class="popup-gallery">
                            <a class="popup1" href="http://placehold.it/800x600"><img src="http://placehold.it/800x600" class="width-100" alt="pic"><span class="eye-wrapper2"><i class="icon icon-cursor-move eye-icon" style="font-size: 38px;"></i></span></a>
                        </div>
                    </div>
                    <!--end popup image -->
                    ...
                    <div class="service-inner blue">
                        ...
                        <a href="#newsletter" class="btn btn-lg btn-services-blue scrool">Discover More!</a>
                ...
                <div class="col-md-4 service-item">
                    ...
                    <div class="service-inner blue">
                        ...
                        <h3>Cool Animations</h3>

                        <p>Curabitur quas nets lacus nulat iaculis etimusad nisle varius vitae seditum ligulase quiste netsum sequi.</p>

                        <a href="#newsletter" class="btn btn-lg btn-services-red scrool">Discover More!</a>
                ...
                <div class="col-md-4 service-item">
                    ...
                    <div class="service-inner blue">
                        ...
                        <h3>24/7 Amazing Support</h3>

                        <p>Curabitur quas nets lacus nulat iaculis etimusad nisle varius vitae seditum ligulase quiste netsum sequi.</p>

                        <a href="#newsletter" class="btn btn-lg btn-services-green scrool">Discover More!</a>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-12 text-center">
                ...
                <!--begin copyright -->
                <div class="copyright">
                    <p>Copyright © 2015 Spectrum. Designed by <a href="http://themeforest.net/user/bogdan_09/portfolio?ref=bogdan_09" target="_blank">Bogdan Preda</a></p>
